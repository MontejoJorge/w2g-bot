...
module.exports = {
   ...
   async execute(interaction) {
      if (
         !interaction.content.startsWith(process.env.prefix) ||
      ...
      const command = interaction.client.commands.get(
         interaction.content.substring(1)
      );
      ...
      if (command) {
         ...
         const embedWarn = new MessageEmbed()
            ...
            .setDescription(
               'We are updating the bot to use slash commands, ' +
         ...
         const embedUpdate = new MessageEmbed()
            ...
            .setDescription(
               'To create the slash commads the bot require new permisions, if you cant see the slash commands, update it by clicking on the link.'
            )
            .setURL(
